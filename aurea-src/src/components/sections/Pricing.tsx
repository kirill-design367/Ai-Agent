...
export default function Pricing() {
  ...
  return (
    <section ref={sectionRef} id="pricing" className="section-padding relative overflow-hidden" style={{ background: 'var(--bg-primary)' }}>
      <GoldenMark variant="rects" size={700} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
      <GoldenMark variant="circles-tr" size={380} className="absolute top-0 right-0" />
