...
export default function Comparison() {
  ...
  return (
    <section ref={sectionRef} className="section-padding relative" style={{ background: 'var(--bg-primary)' }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="comp-table relative rounded-2xl overflow-hidden" style={{ border: '1px solid var(--border)' }}>
          ...
          {/* Header */}
          <div className="comp-header grid grid-cols-3 gap-0" style={{ borderBottom: '1px solid var(--border)' }}>
            <div className="p-5 font-inter text-text-muted text-xs tracking-widest uppercase" />
            <div className="p-5 flex items-center gap-2" style={{ borderLeft: '1px solid var(--border)', background: 'rgba(201,168,124,0.06)' }}>
          ...
          {rows.map((row, i) => (
            ...
            >
              ...
              <div className={`comp-me-${i} p-5 flex items-center gap-2`} style={{ borderLeft: '1px solid var(--border)' }}>
              ...
              <div className="p-5 flex items-center gap-2" style={{ borderLeft: '1px solid var(--border)' }}>
