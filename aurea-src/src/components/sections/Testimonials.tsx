...
export default function Testimonials() {
  ...
  return (
    <section ref={sectionRef} className="section-padding relative overflow-hidden" style={{ background: 'var(--bg-secondary)' }}>
      <div className="orb absolute w-[600px] h-[600px] pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(201,168,124,0.04) 0%, transparent 70%)', top: '30%', left: '-10%' }} />
