...
export default function CTA() {
  ...
  return (
    <section ref={sectionRef} id="contact" className="section-padding relative overflow-hidden" style={{ background: 'var(--bg-secondary)' }}>
      <GoldenMark variant="spiral-br" size={650} className="absolute -bottom-20 -right-20" />
      <GoldenMark variant="sunflower" size={450} className="absolute -top-10 -left-16 opacity-70" />
