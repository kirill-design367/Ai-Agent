...
export default function Deliverables() {
  ...
  return (
    <section ref={sectionRef} id="services" className="section-padding relative" style={{ background: 'var(--bg-secondary)' }}>
      <div className="orb absolute w-[500px] h-[500px] pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(201,168,124,0.05) 0%, transparent 70%)', top: '10%', right: '-5%' }} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="deliv-grid lg:col-span-3 space-y-3">
            {items.map((item, i) => (
              <div
                key={i}
                className="deliv-item group flex items-center justify-between p-5 rounded-xl hover:border-[rgba(201,168,124,0.2)] transition-all duration-300 cursor-default"
                style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}
              >
                <div className="flex items-center gap-4">
                  <div className="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-full" style={{ background: 'rgba(201,168,124,0.08)', border: '1px solid rgba(201,168,124,0.2)' }}>
                    <CheckIcon index={i} />
                  </div>
          ...
          <div className="deliv-card-right lg:col-span-2 opacity-0">
            <div className="h-full rounded-2xl p-8 flex flex-col justify-between relative overflow-hidden" style={{ background: 'var(--surface)', border: '1px solid rgba(201,168,124,0.2)' }}>
              ...
              <div className="relative z-10 mt-8 pt-6" style={{ borderTop: '1px solid rgba(201,168,124,0.15)' }}>
