...
for(const [n,p] of [["home","/"],["case","/keisy/nasledie/"]]){
  const r=await lighthouse("http://localhost:3001"+p,{port:chrome.port,output:"json",logLevel:"error",onlyCategories:["accessibility"],formFactor:"mobile",screenEmulation:{mobile:true,width:360,height:780,deviceScaleFactor:2,disabled:false}});
